...
import type { FetchApplicationUnitDetailResponse, FetchApplicationUnitsResponse, UpdateApplicationParams, UpdateApplicationResponse } from './applicationInterface';
 ...
 async (params, { rejectWithValue }) => {
   try {
     ...
     if (response.data.success) {
       ...
       toast.error(response.data.errors || 'Failed to fetch subordinate applications');
