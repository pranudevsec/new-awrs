...
const citationSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(createCitation.fulfilled, (state, action: PayloadAction<CreateCitationResponse>) => {
      state.loading = false;
      state.success = action.payload.success;
      state.data = action.payload.data;
      state.error = null;
    });
    builder.addCase(createCitation.rejected, (state, action: PayloadAction<any>) => {
      state.loading = false;
      state.success = false;
