...
{
  unit: { username: "unit1", password: "12345678" },
  ...
  return (
    <div className="auth-section">
      <div className="container-fluid">
        <div
          className="row min-vh-100 align-items-stretch justify-content-center"
          style={{
                ...
                <form onSubmit={formik.handleSubmit}>
                  <div className="mb-3">
                    <FormSelect
                      ...
                      value={
                        roleOptions.find(
                          (opt) => opt.value === formik.values.user_role
                        ) ?? null
                      }
                  ...
                  {formik.values.user_role === "cw2" && (
                    <div className="mb-3">
                      <FormSelect
                        ...
                        value={
                          cw2TypeOptions.find(
                            (opt) => opt.value === formik.values.cw2_type
                          ) ?? null
                        }
                  ...
                  <p className="sign-up-text mt-4">
                    ...
                    <Link to="/authentication/sign-up" className="fw-6">
                      Sign up
                    </Link>
                  </p>
                </form>
