        ...
        {isUnitRole && (
          <div className="d-flex flex-md-row flex-column justify-content-center align-items-center gap-3" style={{ marginTop: "1rem" }}>
            ...
            <div className="d-flex align-items-center justify-content-center h-100" style={{
              minWidth: 300, transition: "box-shadow 0.3s ease, transform 0.3s ease",
          ...
          <div className="col-lg-3 col-sm-6 mb-4">
            <Link to="/applications/list" className="h-100 d-block">
              <div className="card border-0 h-100 d-flex align-items-center justify-content-center shadow-sm hover-shadow position-relative">
                ...
                <span className="text-muted small mt-1">Review pending applications</span>
              </div>
            </Link>
          </div>
        )}
            ...
            <div className="col-lg-3 col-sm-6 mb-4">
              <Link to="/clarifications/raised-list" className="h-100 d-block">
                <div className="card border-0 h-100 d-flex align-items-center justify-content-center shadow-sm hover-shadow position-relative">
                  ...
                  <span className="text-muted small mt-1">View clarifications you raised</span>
                </div>
              </Link>
            </div>
            {userRole !== "command" && (
              <div className="col-lg-3 col-sm-6 mb-4">
                <Link to="/clarification" className="h-100 d-block">
                  <div className="card border-0 h-100 d-flex align-items-center justify-content-center shadow-sm hover-shadow position-relative">
                    ...
                    <span className="text-muted small mt-1">Resolve received clarifications</span>
                  </div>
                </Link>
              </div>
            )}
